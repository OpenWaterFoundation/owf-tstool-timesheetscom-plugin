...
#     tstool-timesheetscom-plugin-1.0.0-win-2206060102.zip
...
createPluginZipFile() {
  ...
  "${sevenzip}" a -tzip ${zipFile} owf-tstool-timesheetscom-plugin
  exitStatus=$?
...
devBinFolder="${repoFolder}/owf-tstool-timesheetscom-plugin/target/classes"
pluginsFolder="${HOME}/.tstool/${tstoolMajorVersion}/plugins"
jarFolder="${pluginsFolder}/owf-tstool-timesheetscom-plugin"
pluginDepFolder="${pluginsFolder}/owf-tstool-timesheetscom-plugin/dep"
jarFile="${jarFolder}/owf-tstool-timesheetscom-plugin-${pluginVersion}.jar"
now=$(date +%Y%m%d%H%M)
