...
This repository contains the Open Water Foundation TSTool timesheets.com web services plugin.
This plugin can be installed to enable commands that integrate TSTool with timesheets.com web services.

TSTool is part of [Colorado's Decision Support Systems (CDSS)](https://www.colorado.gov/cdss).
See the following online resources:

*   [TSTool timesheets.com Plugin download page](https://software.openwaterfoundation.org/tstool-timesheetscom-plugin/)
*   [TSTool timesheets.com Plugin Documentation](https://software.openwaterfoundation.org/tstool-timesheetscom-plugin/latest/doc-user/)
...
*   [`timesheets.com` API Documentation](https://support2.timesheets.com/article-categories/timesheets-api/)
  ...
  cdss-dev/                                  Recommended folder for CDSS product development.
    TSTool/                                  Recommended folder for TSTool development.
      git-repos/                             Recommended folder for TSTool product repositories.
        owf-tstool-timesheetscom-plugin/     Repository working files.
          ...
          owf-tstool-timesheetscom-plugin/   Maven project source code and supporting files.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-timesheetscom-plugin/owf-tstool-timesheetscom-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-timesheetscom-plugin` in ***Package Explorer*** or ***Project Explorer***
...
1.  Eclipse project:
    1.  The `owf-tstool-timesheetscom-plugin` repository is added as a Maven project.
...
2.  Plugin jar file:
    ...
    3.  The above script relies on the `owf-tstool-timesheetscom-plugin/src/main/resources/META-INF/MANIFEST.MF`
...
1.  Update the version:
    1.  Update the `src/main/java/owf-tstool-timesheetscom-plugin/org/openwaterfoundation/tstool/plugin/timesheetscom/PluginMeta.java` source file.
